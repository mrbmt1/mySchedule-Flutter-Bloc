...
class SunDayScheduleScreen extends StatefulWidget {
  const SunDayScheduleScreen({Key? key}) : super(key: key);

  @override
  SunDayScheduleScreenState createState() => SunDayScheduleScreenState();
}

class SunDayScheduleScreenState extends State<SunDayScheduleScreen> {
  ...
  void initState() {
    super.initState();
    loadDataForDay('sunday', _subjectControllers);
  }
