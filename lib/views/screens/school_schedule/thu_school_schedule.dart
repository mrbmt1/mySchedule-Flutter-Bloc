...
class ThursDayScheduleScreen extends StatefulWidget {
  ...
  @override
  ThursDayScheduleScreenState createState() => ThursDayScheduleScreenState();
}

class ThursDayScheduleScreenState extends State<ThursDayScheduleScreen> {
  ...
  void initState() {
    super.initState();
    loadDataForDay('thursday', _subjectControllers);
  }
      ...
      listener: (context, state) {
        if (state is SchoolScheduleSuccess) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Cập nhật thành công thời khóa biểu thứ năm'),
