...
class WednesDayScheduleScreen extends StatefulWidget {
  ...
  @override
  WednesDayScheduleScreenState createState() => WednesDayScheduleScreenState();
}

class WednesDayScheduleScreenState extends State<WednesDayScheduleScreen> {
  ...
  void initState() {
    super.initState();
    loadDataForDay('wednesday', _subjectControllers);
  }
      ...
      listener: (context, state) {
        if (state is SchoolScheduleSuccess) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Cập nhật thành công thời khóa biểu thứ tư'),
