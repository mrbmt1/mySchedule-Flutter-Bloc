...
import '../../widgets/school_schedule_widgets/subject_row_widget.dart';

class FriDayScheduleScreen extends StatefulWidget {
  const FriDayScheduleScreen({Key? key}) : super(key: key);

  @override
  FriDayScheduleScreenState createState() => FriDayScheduleScreenState();
}

class FriDayScheduleScreenState extends State<FriDayScheduleScreen> {
  ...
  void initState() {
    super.initState();
    loadDataForDay('friday', _subjectControllers);
  }
      ...
      listener: (context, state) {
        if (state is SchoolScheduleSuccess) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Cập nhật thành công thời khóa biểu thứ sáu'),
