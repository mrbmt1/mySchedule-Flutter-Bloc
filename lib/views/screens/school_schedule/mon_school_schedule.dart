...
class MonDayScheduleScreen extends StatefulWidget {
  ...
  @override
  MonDayScheduleScreenState createState() => MonDayScheduleScreenState();
}

class MonDayScheduleScreenState extends State<MonDayScheduleScreen> {
  ...
  void initState() {
    super.initState();
    loadDataForDay('monday', _subjectControllers);
  }
